      ...
      <section className="bg-forest-dark py-20">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-paper/60 max-w-xl mx-auto">
            Dúvidas gerais, parcerias ou candidaturas — esta é a via directa.
            Para pedidos de evento, usa antes o Pedido de Orçamento.
          </p>
        </div>
      </section>
      ...
      <section className="bg-paper py-16 lg:py-24">
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-[1fr_1.3fr] gap-12">
          ...
          <div className="bg-forest-dark rounded-sm p-8 h-fit">
            <span className="eyebrow">Linha Directa</span>
            <ul className="mt-6 space-y-5">
              <li className="flex items-start gap-3">
                <Phone size={18} className="text-spotlight mt-0.5 shrink-0" />
                <div>
                  <p className="text-paper/40 text-xs font-mono uppercase tracking-widest2">Telefone</p>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-paper/40 text-xs font-mono uppercase tracking-widest2">E-mail</p>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-paper/40 text-xs font-mono uppercase tracking-widest2">Endereço</p>
            ...
            <div className="mt-8 pt-6 border-t border-cue/10">
              <p className="font-mono text-[10px] text-cue tracking-widest2 uppercase mb-2">Horário</p>
              <p className="text-paper/60 text-sm">Segunda a Sexta · 09h00 – 18h00</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              ...
              <Field label="Assunto" name="subject" value={form.subject} onChange={handleChange} required />
            </div>
            <div>
            ...
            {status === 'success' && (
              <p className="flex items-center gap-2 text-cue-dim text-sm pt-2">
                <CheckCircle2 size={16} /> Mensagem enviada. Vamos responder em breve.
              </p>
            )}
            {status === 'error' && (
              <p className="flex items-center gap-2 text-red-600 text-sm pt-2">
                <AlertCircle size={16} /> Não foi possível enviar. Tenta novamente.
              </p>
            )}
          </form>
        </div>
